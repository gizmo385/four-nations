...
var temp__5718__auto____$1 = (o40559["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o40560 = temp__5718__auto____$1;
return (o40560["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22583__auto__ = f;
return (o__22583__auto__["toString"]).call(o__22583__auto__);
} else {
return "";
}
}catch (e40561){var _ = e40561;
return "";
}});
...
try{var o__22583__auto___40563 = t;
(o__22583__auto___40563["cljs$lang$ctorPrWriter"]).call(o__22583__auto___40563,t,writer);
}catch (e40562){var __40564 = e40562;
}
...
var char_code = (function (){var o__22583__auto__ = (new String(char$));
return (o__22583__auto__["charCodeAt"]).call(o__22583__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22583__auto__ = String;
return (o__22583__auto__["fromCharCode"]).call(o__22583__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__40565 = num_code;
switch (G__40565) {
case (1):
return (185);
...
var o__22583__auto__ = String;
return (o__22583__auto__["fromCharCode"]).call(o__22583__auto__,superscript_code);
});
/**
...
}catch (e40567){var _e__22590__auto__ = e40567;
return false;
}})())){
...
var vec__40568 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__40568,(0),null);
...
var temp__5718__auto____$1 = (o40571["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o40572 = temp__5718__auto____$1;
return (o40572["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__40575){
var vec__40576 = p__40575;
var ns_detector = cljs.core.nth.call(null,vec__40576,(0),null);
...
var G__40582 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__40583 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__40582;
remaining_tokens = G__40583;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq40573){
var G__40574 = cljs.core.first.call(null,seq40573);
var seq40573__$1 = cljs.core.next.call(null,seq40573);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40574,seq40573__$1);
}));
...
var vec__40587 = cljs.core.split_with.call(null,(function (p1__40586_SHARP_){
return cljs.core.not_EQ_.call(null,p1__40586_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__40587,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__40587,(1),null);
...
var vec__40593 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__40593,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__40593,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__40596 = cljs.core.rest.call(null,remaining_tokens);
var G__40597 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__40596;
name_tokens = G__40597;
continue;
} else {
...
var vec__40600 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__40600,(0),null);
var arity = cljs.core.nth.call(null,vec__40600,(1),null);
var vec__40603 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__40603,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__40603,(1),null);
var vec__40606 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__40606,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__40606,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__40606,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__40606,(3),null);
...
var vec__40612 = result;
var munged_ns = cljs.core.nth.call(null,vec__40612,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__40612,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__40612,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__40612,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__40612,(4),null);
var arity = cljs.core.nth.call(null,vec__40612,(5),null);
...
var munged_name = cljs.core.nth.call(null,vec__40616,(0),null);
var args = cljs.core.nth.call(null,vec__40616,(1),null);
var vec__40619 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__40619,(0),null);
var name = cljs.core.nth.call(null,vec__40619,(1),null);
...
var G__40622 = (arity + (1));
var G__40623 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__40624){
var vec__40625 = p__40624;
var arity = cljs.core.nth.call(null,vec__40625,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__40625,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__40628_SHARP_){
return cljs.core.get.call(null,arities,p1__40628_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__40629_SHARP_){
return cljs.core.drop.call(null,(2),p1__40629_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__40632){
var vec__40633 = p__40632;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__40633,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq40630){
var G__40631 = cljs.core.first.call(null,seq40630);
var seq40630__$1 = cljs.core.next.call(null,seq40630);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40631,seq40630__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__40641__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__40641__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__40641__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__40641__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__40642 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__40642,(0),null);
var fn_name = cljs.core.nth.call(null,vec__40642,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__40642,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__40642,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__40642,(4),null);
var arity = cljs.core.nth.call(null,vec__40642,(5),null);
...
var o__22583__auto__ = f;
return (o__22583__auto__["getBasis"]).call(o__22583__auto__);
});
/**
...
}catch (e40646){var _e__22590__auto__ = e40646;
...
var G__40647 = (obj[cljs.core.first.call(null,path)]);
var G__40648 = cljs.core.rest.call(null,path);
obj = G__40647;
path = G__40648;
continue;
} else {
...
var _STAR_ = (function (accum,p__40649){
var vec__40650 = p__40649;
var bit = cljs.core.nth.call(null,vec__40650,(0),null);
var protocol = cljs.core.nth.call(null,vec__40650,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__40653){
var vec__40654 = p__40653;
var ns = cljs.core.nth.call(null,vec__40654,(0),null);
var name = cljs.core.nth.call(null,vec__40654,(1),null);
var selector = cljs.core.nth.call(null,vec__40654,(2),null);
...
var post_process = (function (p__40658){
var vec__40659 = p__40658;
var munged_name = cljs.core.nth.call(null,vec__40659,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__40659,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__40657_SHARP_){
return (obj[cljs.core.first.call(null,p1__40657_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1654487548982
