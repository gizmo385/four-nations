...
return (new CustomEvent(event_name,(function (){var obj44550 = ({"detail":data});
return obj44550;
})()));
} else {
...
var f = (function (){var pred__44557 = cljs.core._EQ_;
var expr__44558 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__44557.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__44558))){
return (function (p1__44551_SHARP_){
return console.warn(p1__44551_SHARP_);
});
} else {
if(cljs.core.truth_(pred__44557.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__44558))){
return (function (p1__44552_SHARP_){
return console.debug(p1__44552_SHARP_);
});
} else {
if(cljs.core.truth_(pred__44557.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__44558))){
return (function (p1__44553_SHARP_){
return console.error(p1__44553_SHARP_);
});
} else {
return (function (p1__44554_SHARP_){
return console.log(p1__44554_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__44561){
var map__44562 = p__44561;
var map__44562__$1 = (((((!((map__44562 == null))))?(((((map__44562.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44562.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__44562):map__44562);
var opts = map__44562__$1;
var eval_fn = cljs.core.get.call(null,map__44562__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__44564_SHARP_){
return new_def.callback(p1__44564_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__44565){
var vec__44566 = p__44565;
var ky = cljs.core.nth.call(null,vec__44566,(0),null);
var v = cljs.core.nth.call(null,vec__44566,(1),null);
...
}catch (e44571){if((e44571 instanceof Error)){
var e = e44571;
return not_found;
} else {
throw e44571;
...
//# sourceMappingURL=utils.js.map?rel=1654487552120
