...
}catch (e46346){if((e46346 instanceof Error)){
var e = e46346;
return null;
} else {
throw e46346;
...
figwheel.client.socket.open = (function figwheel$client$socket$open(p__46347){
var map__46348 = p__46347;
var map__46348__$1 = (((((!((map__46348 == null))))?(((((map__46348.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__46348.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__46348):map__46348);
var opts = map__46348__$1;
var retry_count = cljs.core.get.call(null,map__46348__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
var retried_count = cljs.core.get.call(null,map__46348__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var websocket_url = cljs.core.get.call(null,map__46348__$1,new cljs.core.Keyword(null,"websocket-url","websocket-url",-490444938));
var build_id = cljs.core.get.call(null,map__46348__$1,new cljs.core.Keyword(null,"build-id","build-id",1642831089));
...
//# sourceMappingURL=socket.js.map?rel=1654487553460
