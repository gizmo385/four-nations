...
goog.addDependency("../four_nations/general/types.js", ['four_nations.general.types'], ['cljs.core']);
goog.addDependency("../clojure/edn.js", ['clojure.edn'], ['cljs.core', 'cljs.reader']);
goog.addDependency("../four_nations/general/utils.js", ['four_nations.general.utils'], ['cljs.core', 'clojure.edn']);
goog.addDependency("../four_nations/model/map/utils.js", ['four_nations.model.map.utils'], ['cljs.core', 'four_nations.general.types', 'four_nations.general.utils', 'clojure.string']);
goog.addDependency("../four_nations/model/map/resources.js", ['four_nations.model.map.resources'], ['cljs.core', 'four_nations.general.utils']);
goog.addDependency("../four_nations/model/map/biomes.js", ['four_nations.model.map.biomes'], ['four_nations.model.map.utils', 'cljs.core', 'four_nations.general.types', 'four_nations.general.utils']);
goog.addDependency("../four_nations/model/map/enrichments.js", ['four_nations.model.map.enrichments'], ['four_nations.model.map.utils', 'cljs.core', 'four_nations.model.map.resources', 'four_nations.general.types', 'four_nations.model.map.biomes']);
goog.addDependency("../four_nations/model/map/noise_map.js", ['four_nations.model.map.noise_map'], ['four_nations.model.map.utils', 'cljs.core', 'four_nations.general.types', 'four_nations.general.utils']);
goog.addDependency("../four_nations/model/map.js", ['four_nations.model.map'], ['four_nations.model.map.noise_map', 'four_nations.model.map.enrichments', 'cljs.core']);
goog.addDependency("../four_nations/core.js", ['four_nations.core'], ['reagent_modals.modals', 'four_nations.model.map.enrichments', 'goog.string', 'reagent.core', 'four_nations.model.map.utils', 'cljs.core', 'four_nations.general.types', 'goog.string.format', 'four_nations.model.map', 'reagent.dom']);
