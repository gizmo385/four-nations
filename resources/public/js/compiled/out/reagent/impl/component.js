...
if((i < len)){
var k = (ks[i]);
var G__39954 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),goog.object.get(o,k));
var G__39955 = (i + (1));
m = G__39954;
i = G__39955;
continue;
...
return G__39957__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__39959 = c;
var G__39959__$1 = (((G__39959 == null))?null:G__39959.prototype);
if((G__39959__$1 == null)){
return null;
} else {
return G__39959__$1.render;
}
})() == null)))));
});
...
while (G__39963__i < G__39963__a.length) {G__39963__a[G__39963__i] = arguments[G__39963__i + 0]; ++G__39963__i;}
  args = new cljs.core.IndexedSeq(G__39963__a,0,null);
} 
...
var G__39966 = c;
var G__39966__$1 = (((G__39966 == null))?null:G__39966.constructor);
if((G__39966__$1 == null)){
return null;
} else {
return G__39966__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__39967 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__39968 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__39968);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__39967);
}});
...
var G__39969 = key;
var G__39969__$1 = (((G__39969 instanceof cljs.core.Keyword))?G__39969.fqn:null);
switch (G__39969__$1) {
...
var c = this;
var G__39972_39974 = goog.object.get(c,"cljsRatom");
if((G__39972_39974 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__39972_39974);
}
...
var renders_39975 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_39976 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_39975));
...
if((cljs.core.count.call(null,renders_39975) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_39975))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_39976)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_39976)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__39977 = o;
goog.object.set(G__39977,cljs.core.name.call(null,k),v);
...
//# sourceMappingURL=component.js.map?rel=1654487548137
