...
return cljs.core.reduce.call(null,(function (result,p__41897){
var vec__41898 = p__41897;
var k = cljs.core.nth.call(null,vec__41898,(0),null);
var v = cljs.core.nth.call(null,vec__41898,(1),null);
...
var vec__41901 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__41901,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__41901,(1),null);
var ab = cljs.core.nth.call(null,vec__41901,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_41907 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_41907.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_41908 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_41908.call(null,a,b);
}
});
...
return (function (){var G__41912 = clojure.data.equality_partition.call(null,a);
var G__41912__$1 = (((G__41912 instanceof cljs.core.Keyword))?G__41912.fqn:null);
switch (G__41912__$1) {
case "atom":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41912__$1)].join('')));
...
//# sourceMappingURL=data.js.map?rel=1654487550245
